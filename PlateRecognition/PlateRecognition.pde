...
void setup() {
  //println(useNeuralNetwork("5.jpg"));
    ...
    */
    ...
    trainingDigitsSet = createTrainingSet(0, 60000, 784, 26, "emnist-letters-train-images.idx3-ubyte", "emnist-letters-train-labels.idx3-ubyte"); //60000 is the number of letters. change this maybe
